      ...
      <div className="cards">
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            />
            {inputAlert &&
              (inputValues.roll.length === 0 ? (
                <p className="color-red">Roll No is Is Invalid</p>
              ) : (
                <p className="color-green">Roll No is Valid</p>
              ))}
          </div>
          ...
          <div className="form-group">
            ...
            {inputAlert &&
              (inputValues.name.length === 0 ? (
                <p className="color-red">Name is Is Invalid</p>
              ) : (
          ...
          <div className="form-group">
            ...
            {inputAlert &&
              (inputValues.phone.length === 0 ? (
                <p className="color-red">Phone Number is Is Invalid</p>
              ) : inputValues.phone.length >= 10 ? (
                <p className="color-green">Phone Number is correct</p>
              ) : (
                <p className="color-red">Phone Number Must be 10 digit</p>
              ))}
          </div>
